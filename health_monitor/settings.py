...
SECRET_KEY = 'django-insecure-+#4a5^uq9z3l%j29br*nn3h$+t$*t*0!+_t-(y1ul&n2*u(uff'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'data_management/assets'),
]
...
AUTH_USER_MODEL = 'data_management.CustomUser'
